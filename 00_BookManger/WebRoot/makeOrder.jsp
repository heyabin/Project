...
<form action="<%=request.getContextPath()%>/MakeOrderServlet" method="post">
<div class="content">
		 ...
		 <div class="address"><!--收货人地址开始--> 
				...
				<TABLE border=0 cellSpacing=0 width="100%">
				  ...
				  <TR>
					...
					name=" " class=txt maxLength=20 type=text>&nbsp; </TD>
			     </TR>
		...
		<table width="100%" border="0" cellspacing="" cellpadding="5">
		 ...
		 <!-- gwcItem end --> 
		  ...
		  <tr><td colspan="7" align="right" class="zongj">
            ...
            = 商品总计(不含运费)：<span class="fred"><%=gwc.getOldHyPrices()%>元</span>  获得：0 积分点</td>
		  </tr>
		  
		  <tr><td colspan="7">
		    <div class="left">
		       <a class="btn_clear_cart" href="<%=request.getContextPath()%>/InitSevert"><img src="images/jxgw.png"></a>
               <a class="btn_clear_cart" onclick="return confirm('您确定要清空购物车吗?');" href="<%=request.getContextPath()%>/ClearGwcServlet"><img src="images/qkgw.png"></a>
            </div>
					 <div class="right" >
