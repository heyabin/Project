...
<table width="160" border="0" cellspacing="0" cellpadding="2">
  <tr> 
    ...
    <td class="wr4" width="120">
    	<a href="<%=request.getContextPath()%>/FindAllCustomerInfoServlet?nowPage=1" target="mainFrame">用户信息管理</a>
    </td>
  </tr>
   <tr> 
    <td width="40">&nbsp;</td>
  ...
  <tr> 
    <td width="40">&nbsp;</td>
    <td class="wr4" width="120">
    	<a href="<%=request.getContextPath()%>/FindAllCustomerDetailInfoServlet?nowPage=1" target="mainFrame">用户详细管理</a>
    </td>
  </tr>
   <tr> 
    <td width="40">&nbsp;</td>
...
<table width="160" border="0" cellspacing="0" cellpadding="2">
   <tr> 
    <td width="40">&nbsp;</td>
    <td class="wr4" width="120">
    	<a href="<%=request.getContextPath()%>/FindAllOrderMainServlet?nowPage=1" target="mainFrame">订单管理</a>
    </td>
  </tr>
   <tr> 
    <td width="40">&nbsp;</td>
  ...
  <tr> 
    <td width="40">&nbsp;</td>
    <td class="wr4" width="120"><a href="<%=request.getContextPath()%>/FindAllbookDiscussServlet?nowPage=1" target="mainFrame">评论管理</a></td>
  </tr>
   <tr> 
    <td width="40">&nbsp;</td>
