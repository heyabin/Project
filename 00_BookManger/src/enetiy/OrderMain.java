...
public class OrderMain {
	 private String orderNum ;//	varchar(20)  ;//primary key, 	  --订单编号    PK
	 private  int customerId ;//	int      not null,                --客户编号    FK
	 private String   customerName;//	varchar(20)           		  --收货人姓名		
	 private String tel	 ;//       varchar(20)  not null,    	  --收货人电话		
	 private String address	;//	varchar(100)  not null,   	  --收货地址	
	 private String status	;//	char(1) ,        		  --销售单状态（0-未处理，1-已处理，2-以发货，3-已收货）
	 private int adminId	;//	int  ,   		  --处理人编号  FK
	 private String context	;//	varchar(100) not null,	          --备注
	 private double sumprice ;//	 money not null                   --总价
