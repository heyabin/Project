use master
go
if exists(select * from sysdatabases where name='yun4jbookSY1')
	drop database yun4jbookSY1
go
create database yun4jbookSY1
go
use yun4jbookSY1
go
-------------------1图书类别表--------------------
...
insert into 	student(stuName, stuAge, stuBtd, stuSex, stuTel) values	('xiaoming',22,'Mon Apr 04 00:00:00 CST 1994',1, '888888888')