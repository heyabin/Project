  ...
  <div class="t_Top">
	  ...
	  <div class="n_dl_c">
	   ...
	   -->
		...
		<div class="n_zc">
		<form method="post" action="<%=request.getContextPath()%>/show_CustomerRegister.action">
		  ...
		  <table width="780" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <input type="text" id="username" name="customerInfo.custName" class="input_35" tabindex="1" onblur="checkNameReg()"/>
              </td>
            ...
            <tr>
              ...
              <td height="40" colspan="3">
              <input type="password" name="customerInfo.pwd" id="password" class="input_35" 
            ...
            <tr>
              ...
              <td height="40" colspan="3">
              <input type="password" name="repeatPassword" id="repeatPassword"  class="input_35" tabindex="3" onblur="checkRePWDReg()"/>
              </td>
            ...
            <tr>
              ...
              <td height="40" colspan="3">
              <input type="text" name="customerInfo.email" id="email" value=""  class="input_35" 
