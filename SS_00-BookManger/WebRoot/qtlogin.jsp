...
<script type="text/javascript">
  ...
  <div class="t_Top">
	  ...
	  <!-- 登录 -->
	  <form id="login" name="login" method="post" action = "<%=request.getContextPath()%>/show_CustomerLogin.action" onkeydown="onkey(this,event);">
		<div class="n_dl_c">
			<div class="n_dl_c_l">
				...
				<div class="n_dl_c_l_b">
				  ...
				  <table width="262" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td><input type="text" name="customerInfo.custName"/></td>
                    </tr>
                    <tr>
                      <td height="35">密&nbsp;&nbsp;码：</td>
                    ...
                    <tr>
                      ...
                      <input type="submit" name="Submit" value="登 录"  tabindex="5" /></td>
                    </tr>
                    <tr>
				...
				<div class="n_dl_c_r_b">
				  <table width="248" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <input type="button" onclick=" register()" name="Submit2" value="立即免费注册易购"   /> </td>
                    </tr>
                  </table>
				</div>
