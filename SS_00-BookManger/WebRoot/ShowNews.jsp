...
<div class="middle">
    ...
    <div class="middle_right">
        ...
        <table width="100%" border="0">
          <tr>
           <td>新闻编号：${new1.newsId}</td>
           
            <td>新闻作者:${new1.sysAdmin.adminId}</td>
          </tr>
          <tr>
            <td>新闻标题：${new1.title}</td>
            <td>新闻内容：${new1.context}</td>
          </tr>
...
<p>相关新闻：新闻 链接</p>
        ...
        <div class="middle9">
        	<div class="middle9tit">书评:</div>
        		<ul>
        				&nbsp;&nbsp;&nbsp;&nbsp;${bookDicuss.custId }说${bookDiscuss.context}<br><br>
